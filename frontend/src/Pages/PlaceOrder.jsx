        ...
        <div className='mt-12'>
            ...
            <div className='flex gap-3 flex-col lg:flex-row'>
              <div onClick={()=>setMethod('bkash')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
                    ...
                    <img className='w-20 h-auto mx-4' src={assets.bkash} alt="" />
              </div>
              <div onClick={()=>setMethod('nagad')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
                    ...
                    <img className='w-20 h-auto mx-4' src={assets.nagad} alt="" />
              </div>
              ...
              <div onClick={()=>setMethod('credit')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
                    ...
                    <img className='w-12 h-auto mx-4' src={assets.credit} alt="" />
              </div>
